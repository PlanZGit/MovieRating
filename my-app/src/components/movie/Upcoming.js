...
export const Upcoming = () => {
  ...
  const inputFocus = () => {
    document.getElementById("pageNum-icon").style.animation =
      "searchFocus .3s linear 0s 1 normal both ";
  };
  const inputBlur = () => {
    document.getElementById("pageNum-icon").style.animation =
      "searchBlur .3s linear 0s 1 normal both ";
  };
    ...
    <div className="Upcoming">
      <div className="control">
        <NavLink
          ...
          onClick={() =>
            page !== 1 ? clearErrorChangePage(page - 1) : getData(1)
          }
        ...
        <NavLink
          to={page + 1 + ""}
          onClick={() => clearErrorChangePage(page + 1)}
          className={page === state.maxPage ? "notVisible" : ""}>
          Next
